...
public class ModuleIOSparkMax implements ModuleIO {
    ...
    switch (index) {
      case 0:
        ...
        absoluteEncoderOffset =
            new Rotation2d(Math.toRadians(0.877441 * 360)); // MUST BE CALIBRATED
        break;
      case 1:
        ...
        absoluteEncoderOffset =
            new Rotation2d(Math.toRadians(0.841553 * 360)); // MUST BE CALIBRATED
        break;
      case 2:
        ...
        absoluteEncoderOffset =
            new Rotation2d(Math.toRadians(0.823975 * 360)); // MUST BE CALIBRATED
        break;
      case 3:
        ...
        absoluteEncoderOffset =
            new Rotation2d(Math.toRadians(0.138916 * 360)); // MUST BE CALIBRATED
        break;
      default:
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.turnAbsolutePosition =
        new Rotation2d(
                turnAbsoluteEncoder.getAbsolutePosition().getValue()
